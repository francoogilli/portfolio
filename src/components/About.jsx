...
const fadeInAnimationVariants = {
  ...
  function About({ }) {
    ...
    return(
        <section
            id="about" 
            className="mb-28 max-w-[45rem] mx-auto text-center leading-9 px-2 sm:mb-40 scroll-mt-28"
        >            
            <motion.h2 
            ...
            className=" text-gray-300">
                Después de completar la escuela Secundaria, decidí seguir mi pasión por la programación. Me inscribí en la carrera de <span className='font-semibold'>Técnico en Programación</span>, donde profundicé en el mundo del <span className="font-semibold">Desarrollo Web</span>. 
            </motion.p>
            <motion.p
             variants={fadeInAnimationVariants}
             initial="initial"
